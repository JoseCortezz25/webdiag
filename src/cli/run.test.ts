...
import { stubProbes } from '../scan/stub-probe.ts';
 ...
 * network: the default registry runs the real SEC probe, and these tests are
 * about argument dispatch, not about what a live host answered.
 */
